...
- **G2 (Cybersecurity):** Ethical duty to protect user credentials and payment-related flows aligns with OWASP-aware design documented in my [SUNishop — security](../sunishop/security.md).
...
Prior work on **CAKE** (RBAC, documented in the [CAKE — RBAC](../cake/rbac-and-security.md)) showed role separation; G1 added the **why** behind access control — not only “admins can delete” but “power must match accountability.”
