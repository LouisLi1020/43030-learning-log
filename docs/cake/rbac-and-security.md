...
Patterns from CAKE (auth + RBAC) informed what I improved on SUNishop: stricter input validation, injection-aware middleware, and automated tests — documented in the [SUNishop learning log — security](../sunishop/security.md).
