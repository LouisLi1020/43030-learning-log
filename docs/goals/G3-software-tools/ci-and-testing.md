...
See [ci-workflow.yml](ci-workflow.yml) in this folder for a GitHub Actions template aligned with the MERN layout (`server/`, `client/`). The live workflow is in the app repo: `.github/workflows/ci.yml`.

## Evidence for reviewers

- Screenshot of a green workflow run (attach in portfolio submission / Figure 3)
