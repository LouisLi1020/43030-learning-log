...
- G2 controls in API middleware — [G2 security](../G2-cybersecurity/security-threats-and-mitigations.md)
- G3 CI validates server + client build — [G3 CI](../G3-software-tools/ci-and-testing.md)
